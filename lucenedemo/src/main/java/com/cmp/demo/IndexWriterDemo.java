...
public class IndexWriterDemo {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        //createIndex("E:/workspace/projs/lucenedemo/target/lucene");
        readIndex("E:/workspace/projs/lucenedemo/target/lucene");
        readAllIndexDocs("E:/workspace/projs/lucenedemo/target/lucene");
    }
