...
public class YouPaiYun {
     ...
     * @return UPYun object
     */
    public YouPaiYun(String bucketName, String userName, String password) {
    ...
    public enum PARAMS {
         ...
         *
         * @see ://wiki.upyun.com/index.php?title=缩略图方式差别举例
         */
         ...
         *
         * @see ://wiki.upyun.com/index.php?title=如何创建自定义缩略图
         */
         ...
         *
         * @see ://wiki.upyun.com/index.php?title=图片旋转
         */
         ...
         * > 0
         *
         * @see ://wiki.upyun.com/index.php?title=图片裁剪
         */
